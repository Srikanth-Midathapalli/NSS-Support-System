...
$result = $conn->query("SELECT DISTINCT w.WorkID, w.Name, w.Description, w.Duration, w.DeadlineToApply 
						...
						WHERE wpi.Status = 'PENDING' AND wpi.WorkID = w.WorkID");
...
?>
	 	<br><br>
		<form action="dept_approve_select_students.php" method="post">
			<input type="hidden" name="id" value="<?php echo $row["WorkID"];?>">
			<input type="submit" name="submit" value="View Student Requests">
		</form>
